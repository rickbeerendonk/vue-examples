...
export default {
  ...
  beforeCreate() {
    ...
    logEvent('mixin1', 'beforeCreate()', this);
  },
  created() {
    // Called synchronously
    // - after the instance is created
    logEvent('mixin1', 'created()', this);
  },
  beforeMount() {
    // Called
    // - before the mounting begins: the render function is about to be called for the first time.
    logEvent('mixin1', 'beforeMount()', this);
  },
  mounted() {
    // Called
    ...
    this.$nextTick(() => logEvent('mixin1', 'mounted()', this));
  },
  beforeUpdate() {
    ...
    logEvent('mixin1', 'beforeUpdate()', this);
  },
  updated() {
    // Called
  ...
  activated() {
    ...
    //
    // Note: Not called during server-side rendering
    logEvent('mixin1', 'activated()', this);
  },
  deactivated() {
    // Called when a kept-alive component is deactivated.
    //
    // Note: Not called during server-side rendering
    logEvent('mixin1', 'deactivated()', this);
  },
  beforeDestroy() {
    // Called
    ...
    //
    // Note: Not called during server-side rendering.
    logEvent('mixin1', 'beforeDestroy()', this);
  },
  destroyed() {
    // Called
    ...
    //
    // Note: Not called during server-side rendering.
    logEvent('mixin1', 'destroyed()', this);
  }
};
